...
export const SelectField = forwardRef<HTMLSelectElement, SelectFieldProps>(
    ({ tag, label, options, error, translation, ...props }, ref) => {
        const t = useTranslations("Form");
        const l = useTranslations(tag);
        return (
            <div className="flex flex-col gap-2">
                <label className="text-xs font-mono text-slate-400 uppercase tracking-widest">
                    {t(label)}
...
export const ImageUpload = ({ preview, onFileChange }: ImageUploadProps) => {
